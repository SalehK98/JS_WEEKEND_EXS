...
// How to solve : 
// go on each element of the array and compute the difference 
//and add it each time to the previous element difference using reduce keeps track every time

const number = function (busStops) {
    const result = busStops.reduce((total, currentVal) => {
        total += currentVal[0] - currentVal[1]
        return total
    }, 0)
    return result
}